...
export async function generateExcelCatalog(products: ExportProduct[], name: string = 'Catalogue') {
...
export async function generatePPTCatalog(products: ExportProduct[], title: string = 'Catalogue', buyerInfo: string = '') {
...
export async function generatePDFCatalog(products: ExportProduct[], title: string = 'Catalogue', buyerInfo: string = '') {
